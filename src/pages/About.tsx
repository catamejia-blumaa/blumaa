          ...
          <div className="grid md:grid-cols-[300px_1fr] gap-12 items-start relative">
            ...
            >
              ...
              <div>
                ...
                <h3 className="text-xl font-serif">{tr.founderName}</h3>
              </div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
          ...
          >
            <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              ...
              <div className="bg-blue/5 rounded-2xl p-8 border-2 border-blue/20">
                <div className="mb-6">
                  <p className="text-night/70 text-sm uppercase tracking-wider mb-2 font-semibold">{tr.wayThink}</p>
              ...
              <div className="bg-blue rounded-2xl p-8 text-white-chocolate border-2 border-blue">
                <div className="mb-6">
                  <p className="text-light-yellow text-sm uppercase tracking-wider mb-2 font-semibold">{tr.wayBuild}</p>
