      ...
      <section className="py-24 md:py-32 bg-blue">
        <div className="container max-w-3xl relative z-10">
          <motion.div initial="hidden" animate="visible">
            <motion.p variants={fadeUp} custom={0} className="text-light-yellow font-semibold text-sm uppercase tracking-[0.2em] mb-4 drop-shadow-sm">{tr.tag}</motion.p>
            ...
            >
              ...
              <div className={i % 2 === 1 ? "md:order-1" : ""}>
                <div className="bg-blue-dark text-white-chocolate rounded-xl p-8 mb-6 shadow-xl">
                  <h4 className="font-sans font-semibold text-sm uppercase tracking-widest mb-4 text-light-yellow">{tr.included}</h4>
                ...
                <div className="bg-white rounded-xl p-8 border-2 border-blue/10 shadow-md">
                  <h4 className="font-sans font-semibold text-sm uppercase tracking-widest mb-3 text-blue-dark">{tr.forWho}</h4>
      ...
      <section className="py-24 bg-blue-dark text-white-chocolate">
        <div className="container text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-4xl md:text-5xl font-serif mb-6 drop-shadow-sm">{tr.ctaH2}</h2>
