    ...
    <footer className="bg-blue-dark text-white-chocolate py-16">
      <div className="container relative z-10">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <h4 className="font-sans font-semibold text-sm uppercase tracking-widest mb-4 text-white-chocolate">{ft.navigate}</h4>
          ...
          <div>
            <h4 className="font-sans font-semibold text-sm uppercase tracking-widest mb-4 text-white-chocolate">{ft.connect}</h4>
